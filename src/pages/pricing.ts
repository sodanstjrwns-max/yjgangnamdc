export function pricingPage(): string {
  ...
  <section class="py-20 md:py-32 bg-white">
    <div class="max-w-5xl mx-auto px-6 md:px-8 lg:px-12">
      ...
      <!-- Notice -->
      <div class="glass-gold rounded-3xl p-7 mb-20 reveal relative overflow-hidden">
        <div class="absolute -top-10 -right-10 w-32 h-32 bg-gold/[0.04] rounded-full blur-[60px]"></div>
        <div class="flex items-start gap-5 relative z-10">
          <div class="w-12 h-12 rounded-xl gold-grad flex items-center justify-center flex-shrink-0 gold-glow"><i class="fas fa-info text-white"></i></div>
          <div>
            <h3 class="font-extrabold text-charcoal mb-3">비용 안내 사항</h3>
            <ul class="text-sm text-gray-500 space-y-1.5">
              <li class="flex items-start gap-2"><span class="w-1 h-1 rounded-full bg-gold mt-2 flex-shrink-0"></span>아래 비용은 참고용이며, 환자분의 구강 상태에 따라 달라질 수 있습니다.</li>
              <li class="flex items-start gap-2"><span class="w-1 h-1 rounded-full bg-gold mt-2 flex-shrink-0"></span>정확한 비용은 진단 후 상담 시 안내드립니다.</li>
              <li class="flex items-start gap-2"><span class="w-1 h-1 rounded-full bg-gold mt-2 flex-shrink-0"></span>건강보험 적용 항목은 본인부담금이 달라집니다.</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="space-y-16">
        ...
        <div class="reveal">
          <div class="flex items-center gap-4 mb-8">
            <div class="w-13 h-13 rounded-2xl gold-grad flex items-center justify-center gold-glow" style="width:52px;height:52px;">
          ...
          <div class="card-premium overflow-hidden">
            <div class="divide-y divide-gray-50">
              ...
              <div class="flex items-center justify-between px-7 py-5 hover:bg-gold/[0.02] transition-colors duration-300 group">

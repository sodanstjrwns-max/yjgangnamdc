...
// ========== 진료과목별 대폭 확장 FAQ (카테고리당 15-25개, 총 170개) ==========
export const allFAQs: FAQItem[] = [
  ...
  // 임플란트 추가 15개 (총 30개)
  { category: '임플란트', categorySlug: 'implant', q: '임플란트 주위염이란 무엇인가요?', a: '임플란트 주위염은 임플란트 주변 잇몸과 뼈에 염증이 생기는 것입니다. 자연치아의 치주염과 유사합니다. 잇몸 출혈, 붓기, 고름, 임플란트 흔들림이 주요 증상이며 방치 시 임플란트를 제거해야 할 수 있습니다. 6개월마다 정기 검진으로 예방하는 것이 중요합니다.' },
  { category: '임플란트', categorySlug: 'implant', q: '임플란트 수술 후 흡연해도 되나요?', a: '수술 후 최소 2주, 가능하면 8주 이상 금연을 강력히 권합니다. 흡연은 혈류를 감소시켜 뼈 유착(골유합)을 방해하고, 감염 위험을 높이며 임플란트 실패율을 2~3배 증가시킵니다. 장기적으로도 임플란트 주위염 발생률이 흡연자에게서 훨씬 높습니다.' },
  { category: '임플란트', categorySlug: 'implant', q: '임플란트 식립 후 임시치아를 사용할 수 있나요?', a: '네, 가능합니다. 골유합 기간(2~4개월) 동안 빈 공간이 보기 싫으시면 임시치아를 장착할 수 있습니다. 특히 앞니 부위는 심미적 이유로 임시치아를 추천합니다. 강남치과의원 임시치아 비용은 1본 15,000원이며, 최종 보철 장착 시 교체됩니다.' },
  { category: '임플란트', categorySlug: 'implant', q: '고혈압이 있어도 임플란트 수술이 가능한가요?', a: '혈압이 약물로 잘 조절되고 있다면 임플란트 수술이 가능합니다. 수술 당일 혈압을 측정하여 안전 범위(수축기 180mmHg, 이완기 110mmHg 미만) 내인지 확인합니다. 조절되지 않는 고혈압은 출혈 위험이 있으므로 내과 조절 후 수술을 진행합니다.' },
  { category: '임플란트', categorySlug: 'implant', q: '임플란트 브랜드(Neo, Osstem)에 따라 차이가 있나요?', a: '강남치과의원에서 사용하는 Neo와 Osstem은 모두 국내 점유율 상위 브랜드로, 전 세계적으로 검증된 안전한 임플란트입니다. 표면 처리 기술과 나사 디자인에 차이가 있으나, 둘 다 골유합률과 장기 생존율이 우수합니다. 환자의 뼈 상태에 따라 최적 브랜드를 추천드립니다.' },
  { category: '임플란트', categorySlug: 'implant', q: '디지털 가이드 임플란트란 무엇인가요?', a: '3D CT 데이터를 바탕으로 컴퓨터에서 임플란트 위치, 각도, 깊이를 사전에 계획하고, 맞춤형 가이드를 제작하여 정확하게 식립하는 기술입니다. 수술 오차가 0.5mm 이내로 최소화되어 안전성이 높고, 수술 시간이 단축되며 절개 범위가 줄어 회복이 빠릅니다.' },
  { category: '임플란트', categorySlug: 'implant', q: '임플란트 보철물이 깨질 수 있나요?', a: '극히 드물지만 강한 외력(사고, 매우 딱딱한 음식)에 의해 보철물(크라운)이 파절될 수 있습니다. 이 경우 임플란트 본체(픽스쳐)는 그대로 두고 보철물만 재제작하여 교체하면 됩니다. 이갈이 습관이 있으면 야간용 보호장치(나이트가드) 착용을 권합니다.' },
  { category: '임플란트', categorySlug: 'implant', q: '골다공증 약(비스포스포네이트)을 복용 중인데 임플란트가 가능한가요?', a: '비스포스포네이트 계열 약물은 뼈 대사를 억제하여 턱뼈 괴사(BRONJ) 위험이 있습니다. 경구 복용(3년 미만)은 상대적으로 안전하나, 주사제 투여 중이거나 장기 복용자는 주치의와 반드시 협진해야 합니다. 구강외과 전문의가 위험도를 평가하여 수술 가능 여부를 판단합니다.' },
  { category: '임플란트', categorySlug: 'implant', q: '임플란트 실패 후 재수술이 가능한가요?', a: '네, 가능합니다. 임플란트 실패(탈락, 감염)가 발생해도 실패 원인을 분석하고, 뼈가 회복되면 동일 부위에 재식립이 가능합니다. 뼈 부족 시 뼈이식을 병행합니다. 구강외과 전문의의 재수술 경험이 중요하며, 타 병원 실패 케이스 상담도 가능합니다.' },
  { category: '임플란트', categorySlug: 'implant', q: '틀니를 임플란트로 교체할 수 있나요?', a: '네, 틀니가 불편하시면 임플란트로 전환할 수 있습니다. 완전 고정식 임플란트(All-on-4/6 등)로 전환하거나, 2~4개 임플란트를 심어 틀니를 고정하는 임플란트 오버덴처로 변경할 수 있습니다. 뼈 상태에 따라 최적의 방법을 안내드립니다.' },
  { category: '임플란트', categorySlug: 'implant', q: '임플란트 수술 당일 운전할 수 있나요?', a: '국소마취로 진행되므로 의식이 명확하여 일반적으로 운전이 가능합니다. 다만, 복잡한 수술(뼈이식 동반, 다수 식립)이나 진정마취를 한 경우에는 보호자 동행을 권합니다. 수술 후 약간의 불편감이나 마취 잔여 효과가 있을 수 있으므로 무리하지 마세요.' },
  { category: '임플란트', categorySlug: 'implant', q: '임플란트 수술 후 일상 복귀까지 얼마나 걸리나요?', a: '단순 식립 수술 후 1~2일이면 일상생활에 복귀 가능합니다. 부기가 최대인 2~3일째까지는 무리하지 않는 것이 좋습니다. 뼈이식 등 복합 수술은 3~5일 정도 안정을 취하시길 권합니다. 사무직은 다음 날부터, 육체 노동은 1주일 후 복귀를 권장합니다.' },
  { category: '임플란트', categorySlug: 'implant', q: '혈액 희석제(아스피린, 와파린)를 복용 중인데 수술이 가능한가요?', a: '저용량 아스피린(100mg)은 중단 없이 수술 가능한 경우가 많습니다. 와파린, 클로피도그렐 등 강한 항응고제는 출혈 위험을 평가하여 내과 주치의와 협의 후 결정합니다. 약물 중단 여부는 혈전 위험과 출혈 위험을 함께 고려해야 하므로 반드시 전문의 상담이 필요합니다.' },
  { category: '임플란트', categorySlug: 'implant', q: '임플란트 식립 후 음식은 언제부터 먹을 수 있나요?', a: '마취가 풀린 후(약 2~3시간 뒤)부터 미지근한 부드러운 음식(죽, 스프, 으깬 감자 등)을 드실 수 있습니다. 1~2주간은 수술 부위로 씹지 말고 반대쪽으로 식사하세요. 딱딱하거나 질긴 음식은 4주 이상 피하시고, 최종 보철 장착 전까지는 수술 부위에 무리한 하중을 주지 마세요.' },
  { category: '임플란트', categorySlug: 'implant', q: '네오(Neo) 임플란트의 특징은 무엇인가요?', a: 'Neo 임플란트는 국내 프리미엄 임플란트 시스템으로, SLA 표면처리 기술을 적용하여 뼈와의 결합력(골유합)이 뛰어납니다. 다양한 직경과 길이가 있어 환자별 맞춤 선택이 가능하며, 생체적합성이 높은 Grade 4 순수 티타늄을 사용합니다. 전 세계 다수 국가에서 사용되는 검증된 제품입니다.' },
  ...
  // 디지털 보철 추가 12개 (총 24개)
  { category: '디지털 보철 (CEREC)', categorySlug: 'digital-prosthesis', q: 'CEREC 크라운은 당일 장착이 가능한가요?', a: '디지털 스캔(5분) → AI 설계(10분) → 밀링(15분) → 소성(15분) → 장착(10분)으로, 치아 삭제부터 최종 장착까지 약 1~2시간이면 완료됩니다. 단, 치아 상태에 따라 당일 장착이 어려운 경우도 있으며, 정밀도를 위해 2회 내원이 필요한 케이스도 있습니다.' },
  { category: '디지털 보철 (CEREC)', categorySlug: 'digital-prosthesis', q: 'CEREC 크라운이 잘 안 맞으면 어떻게 하나요?', a: '디지털 설계로 제작되어 적합도가 매우 높지만, 장착 후 교합(물리는 느낌)이 불편하다면 미세 조정이 가능합니다. 며칠 사용 후에도 불편하시면 내원하셔서 조정받으시면 됩니다. 강남치과의원은 만족하실 때까지 꼼꼼하게 조정합니다.' },
  { category: '디지털 보철 (CEREC)', categorySlug: 'digital-prosthesis', q: 'CEREC 세라믹 블록은 어떤 소재인가요?', a: '지르코니아 블록은 이트리아 안정화 지르코니아(Y-TZP)로 1,200MPa 이상의 굴곡 강도를 가집니다. 올세라믹 블록(e.max 등)은 리튬 디실리케이트 글라스 세라믹으로 빛 투과성이 뛰어납니다. 모두 생체적합성이 검증된 의료용 소재이며, 금속 프리(Metal-Free)입니다.' },
  { category: '디지털 보철 (CEREC)', categorySlug: 'digital-prosthesis', q: 'SpeedFire 소성 과정이 왜 필요한가요?', a: '밀링 직후의 지르코니아 블록은 아직 최종 강도에 도달하지 않은 상태입니다. SpeedFire에서 1600℃로 15분간 소성하면 분자 결정 구조가 완성되어 최종 강도(1,200MPa 이상)와 자연스러운 색감이 구현됩니다. 기존 소성로(8시간)보다 30배 이상 빨라 환자 대기 시간이 크게 줄어듭니다.' },
  { category: '디지털 보철 (CEREC)', categorySlug: 'digital-prosthesis', q: 'CEREC 크라운과 금 크라운 중 어떤 것이 좋은가요?', a: '금 크라운은 생체적합성이 우수하고 교합 적합성이 좋지만, 심미성이 떨어집니다. CEREC 지르코니아 크라운은 금보다 강도가 높으면서도 자연치아 색상을 재현합니다. 심미성을 중시하면 CEREC, 경제적 부담을 줄이면서 검증된 소재를 원하시면 금 크라운을 추천합니다.' },
  { category: '디지털 보철 (CEREC)', categorySlug: 'digital-prosthesis', q: '디지털 스캔 시 불편하지 않나요?', a: '전혀 불편하지 않습니다. PrimeScan은 작은 카메라 헤드로 치아를 촬영하는 방식이라, 실리콘 인상재(본뜨기)처럼 구역질이 나거나 불쾌감이 없습니다. 약 5분이면 구강 전체 스캔이 완료되며, 실시간으로 화면에서 3D 모델을 확인하실 수 있습니다.' },
  { category: '디지털 보철 (CEREC)', categorySlug: 'digital-prosthesis', q: '크라운 장착 후 시린 증상이 있을 수 있나요?', a: '일시적으로 차갑거나 뜨거운 자극에 시린 느낌이 있을 수 있습니다. 이는 치아를 삭제하는 과정에서 상아세관이 자극받기 때문이며, 보통 1~4주 내 자연 소실됩니다. 시린이 전용 치약 사용이 도움됩니다. 증상이 심하거나 오래 지속되면 내원하셔서 확인받으세요.' },
  { category: '디지털 보철 (CEREC)', categorySlug: 'digital-prosthesis', q: 'CEREC으로 브릿지나 인레이도 만들 수 있나요?', a: '현재 강남치과의원에서는 CEREC으로 싱글 크라운(지르코니아, 올세라믹)을 주력으로 제작하고 있습니다. 브릿지, 인레이, 라미네이트 등은 기공소와 협력하여 정밀 제작합니다. 어떤 보철이든 PrimeScan 디지털 스캔 데이터를 기반으로 설계하므로 정밀도가 높습니다.' },
  { category: '디지털 보철 (CEREC)', categorySlug: 'digital-prosthesis', q: '크라운 치료 후 관리는 어떻게 해야 하나요?', a: '일반 치아처럼 양치질, 치실, 치간칫솔로 관리하시면 됩니다. 크라운 자체는 충치가 생기지 않지만, 크라운과 치아 경계면에 2차 충치가 생길 수 있으므로 경계 부위를 꼼꼼하게 관리하세요. 딱딱한 것(얼음, 사탕)을 깨무는 습관은 피하시고, 6개월마다 정기 검진을 받으세요.' },
  { category: '디지털 보철 (CEREC)', categorySlug: 'digital-prosthesis', q: '크라운 색상을 주변 치아와 맞출 수 있나요?', a: '네, CEREC 시스템은 다층(Multi-layer) 세라믹 블록을 사용하여 잇몸 쪽은 진한 색, 절단면은 투명한 색의 그라데이션을 구현합니다. 인접 치아의 색상과 매칭하여 블록을 선택하므로, 주변 치아와 거의 구분되지 않는 자연스러운 결과를 만듭니다.' },
  { category: '디지털 보철 (CEREC)', categorySlug: 'digital-prosthesis', q: 'CEREC 크라운은 알레르기가 없나요?', a: '세라믹과 지르코니아는 금속이 전혀 포함되지 않은 Metal-Free 소재이므로, 금속 알레르기 걱정이 없습니다. 니켈 알레르기가 있어 기존 PFM(금속 도재) 크라운에 문제가 있었던 분도 안전하게 사용하실 수 있습니다. 생체적합성이 매우 우수한 소재입니다.' },
  { category: '디지털 보철 (CEREC)', categorySlug: 'digital-prosthesis', q: '어금니와 앞니 크라운 소재가 다른 이유는 무엇인가요?', a: '어금니는 씹는 힘(교합력)이 강하므로 강도가 최고인 지르코니아 크라운이 적합합니다. 앞니는 심미성이 중요하므로 빛 투과성이 자연치아와 유사한 올세라믹(e.max) 크라운이 적합합니다. 강남치과의원에서는 치아 위치와 기능에 맞춰 최적 소재를 안내드립니다.' },
  ...
  // 인비절라인 추가 12개 (총 24개)
  { category: '인비절라인', categorySlug: 'invisalign', q: '인비절라인 착용하면 발음에 영향이 있나요?', a: '처음 1~3일은 약간의 혀 꼬임이나 발음 부정확함이 있을 수 있지만, 대부분 3~5일 이내에 완전히 적응됩니다. 얼라이너가 얇고 치아에 밀착되어 브라켓 교정보다 발음 영향이 훨씬 적습니다. 발표나 회의가 잦은 직장인도 무리 없이 사용하십니다.' },
  { category: '인비절라인', categorySlug: 'invisalign', q: '인비절라인 장치 관리는 어떻게 하나요?', a: '매일 미지근한 물과 부드러운 칫솔로 세척하세요. 뜨거운 물은 장치 변형의 원인이 되므로 피하세요. 착용 전후 양치질을 꼭 하시고, 커피·주스 등 색소 음료는 장치를 빼고 드세요. 1~2주마다 새 얼라이너로 교체되므로 위생 관리가 편리합니다.' },
  { category: '인비절라인', categorySlug: 'invisalign', q: '교정 중 어태치먼트(돌기)는 무엇인가요?', a: '어태치먼트는 치아 표면에 붙이는 작은 레진 돌기로, 얼라이너가 치아를 정확한 방향으로 이동시키는 데 도움을 줍니다. 치아색 레진이라 잘 보이지 않으며, 교정 완료 후 깨끗하게 제거됩니다. 모든 치아에 필요한 것은 아니고, 교정 계획에 따라 필요한 치아에만 부착합니다.' },
  { category: '인비절라인', categorySlug: 'invisalign', q: '인비절라인 교정 중 치아 삭제(IPR)가 필요한가요?', a: 'IPR(Interproximal Reduction)은 치아 사이를 0.1~0.5mm 정도 미세하게 다듬어 교정 공간을 확보하는 방법입니다. 발치 없이 공간을 만들 수 있어 치아 보존적이며, 법랑질 두께 범위 내에서 시행하므로 치아에 해롭지 않습니다. 모든 케이스에 필요한 것은 아닙니다.' },
  { category: '인비절라인', categorySlug: 'invisalign', q: '임신 중에 인비절라인 교정을 시작할 수 있나요?', a: '임신 중에는 X-ray 촬영이 제한되고 호르몬 변화로 잇몸이 예민해질 수 있어, 새로 교정을 시작하는 것은 권장하지 않습니다. 다만, 이미 교정 중이라면 담당 의사와 상의하여 안전하게 계속할 수 있습니다. 출산 후 시작하시는 것을 권합니다.' },
  { category: '인비절라인', categorySlug: 'invisalign', q: '인비절라인 퍼스트(1차 교정)란 무엇인가요?', a: '인비절라인 퍼스트는 성장기 어린이(만 6~10세)를 위한 1차 교정 프로그램입니다. 유치와 영구치가 섞여 있는 혼합치열기에 악궁을 확장하고 치아 배열을 개선합니다. 강남치과의원 비용은 400만원이며, 2차 교정 필요성을 줄이는 예방적 효과가 있습니다.' },
  { category: '인비절라인', categorySlug: 'invisalign', q: '인비절라인 교정 중 충치가 생기면 어떻게 하나요?', a: '교정 중 충치가 발견되면 즉시 치료합니다. 인비절라인은 탈착이 가능하므로 충치 치료 접근이 브라켓 교정보다 훨씬 쉽습니다. 치료 후 치아 형태가 약간 바뀌면 해당 단계 얼라이너를 재제작할 수 있습니다. 교정 중 양치를 철저히 하는 것이 중요합니다.' },
  { category: '인비절라인', categorySlug: 'invisalign', q: '3D 클린체크 시뮬레이션이란 무엇인가요?', a: '클린체크는 iTero 스캔 데이터를 바탕으로 교정 시작부터 완료까지 치아 이동 과정을 3D 영상으로 시뮬레이션하는 기술입니다. 교정 전·후 모습을 미리 확인하고, 치료 기간, 필요 얼라이너 수 등을 정확히 예측할 수 있습니다. 상담 시 직접 화면으로 보여드립니다.' },
  { category: '인비절라인', categorySlug: 'invisalign', q: '얼라이너를 분실했을 때 어떻게 하나요?', a: '이전 단계 얼라이너를 착용하면서 치과에 연락해주세요. 다음 단계 얼라이너로 건너뛸 수 있는 경우도 있고, 해당 단계를 재제작하는 경우도 있습니다. 분실 방지를 위해 외출 시 전용 케이스에 보관하시는 것을 권합니다.' },
  { category: '인비절라인', categorySlug: 'invisalign', q: '인비절라인 교정 중 스포츠 활동에 지장이 있나요?', a: '인비절라인은 금속 브라켓이 없어 스포츠 중 입 안 상처 위험이 없습니다. 가벼운 운동은 착용 상태로 가능하며, 격렬한 접촉 스포츠(축구, 농구 등)시에는 별도 마우스가드 착용을 권합니다. 수영도 장치 착용 상태로 가능합니다.' },
  { category: '인비절라인', categorySlug: 'invisalign', q: '인비절라인으로 앞니만 부분 교정이 가능한가요?', a: '네, 앞니 벌어짐, 가벼운 삐뚤어짐 등 부분 교정에 인비절라인이 매우 효과적입니다. 인비절라인 라이트(Lite) 또는 Go 시스템으로 6~12개월의 짧은 기간에 앞니만 집중 교정할 수 있습니다. 비용도 풀 교정보다 저렴합니다.' },
  { category: '인비절라인', categorySlug: 'invisalign', q: '교정 중 화이트닝(미백)도 함께 할 수 있나요?', a: '인비절라인 교정 중에도 미백이 가능합니다. 얼라이너 안에 미백 젤을 넣어 착용하는 방법도 있으나, 교정이 완료된 후 미백을 하시는 것이 색상 균일성 면에서 더 좋은 결과를 얻을 수 있습니다. 담당 의사와 상의하세요.' },
  ...
  // 사랑니 발치 추가 10개 (총 20개)
  { category: '사랑니 발치', categorySlug: 'wisdom-tooth', q: '사랑니 발치 후 먹을 수 있는 음식은 무엇인가요?', a: '발치 후 2~3일간은 미지근한 부드러운 음식(죽, 스프, 두부, 바나나, 아이스크림, 계란찜 등)을 드세요. 뜨거운 국물, 매운 음식, 딱딱한 음식은 피하세요. 빨대 사용은 드라이 소켓 위험이 있으므로 피하시고, 1주일 후부터 점차 정상 식사로 돌아가실 수 있습니다.' },
  { category: '사랑니 발치', categorySlug: 'wisdom-tooth', q: '사랑니 발치 비용은 얼마인가요?', a: '사랑니 발치는 건강보험이 적용됩니다. 단순 발치의 경우 본인부담금 약 1~3만원, 매복 사랑니(난이도에 따라 분류)는 약 3~10만원 수준입니다. 3D CT 촬영비도 보험 적용됩니다. 정확한 비용은 촬영 후 확인 가능합니다.' },
  { category: '사랑니 발치', categorySlug: 'wisdom-tooth', q: '사랑니 발치 후 출혈이 멈추지 않으면 어떻게 하나요?', a: '거즈를 발치 부위에 대고 30분~1시간 동안 꽉 물고 계세요. 침이나 피를 자주 뱉지 마시고, 침과 함께 삼키세요. 출혈이 2~3시간 후에도 멈추지 않으면 치과에 연락하세요. 고혈압약이나 혈액 희석제를 드시는 분은 사전에 알려주세요.' },
  { category: '사랑니 발치', categorySlug: 'wisdom-tooth', q: '하치조신경 손상이란 무엇인가요?', a: '하치조신경은 아래턱을 지나는 감각 신경으로, 아랫입술과 턱의 감각을 담당합니다. 아래 매복 사랑니가 이 신경과 매우 가까울 때 발치 중 손상 위험이 있습니다. 3D CT로 정확한 거리를 측정하여 안전하게 발치하며, 강남치과의원은 신경 손상 위험을 최소화하는 전문 기술을 보유하고 있습니다.' },
  { category: '사랑니 발치', categorySlug: 'wisdom-tooth', q: '사랑니 발치는 몇 분 정도 걸리나요?', a: '단순 사랑니(정상 맹출)는 5~10분, 일반 매복 사랑니는 15~30분, 완전 매복이나 고난이도 사랑니는 30~40분 정도 소요됩니다. 구강외과 전문의의 숙련도에 따라 시간이 크게 달라지며, 강남치과의원은 풍부한 발치 경험으로 수술 시간을 최소화합니다.' },
  { category: '사랑니 발치', categorySlug: 'wisdom-tooth', q: '윗사랑니와 아랫사랑니 발치 중 어느 쪽이 더 어려운가요?', a: '일반적으로 아래 사랑니 발치가 더 어렵습니다. 아래턱 뼈가 위턱보다 단단하고, 하치조신경관이 근처에 있으며, 매복 빈도도 높기 때문입니다. 윗사랑니는 뼈가 상대적으로 부드러워 발치가 수월한 편이나, 상악동(부비강)과의 관계를 확인해야 합니다.' },
  { category: '사랑니 발치', categorySlug: 'wisdom-tooth', q: '사랑니 발치 후 운동은 언제부터 가능한가요?', a: '발치 후 3~5일간은 격렬한 운동을 피하세요. 운동 시 혈압이 올라가면 출혈이 재발할 수 있습니다. 가벼운 산책은 다음 날부터 가능하며, 웨이트 트레이닝, 달리기, 수영 등 강도 높은 운동은 1주일 후부터 서서히 시작하세요.' },
  { category: '사랑니 발치', categorySlug: 'wisdom-tooth', q: '사랑니 주변에 낭종이 생길 수 있나요?', a: '네, 매복 사랑니를 오래 방치하면 주변에 함치성 낭종(dentigerous cyst)이 생길 수 있습니다. 낭종은 천천히 커지면서 주변 뼈를 녹이고 인접 치아에 영향을 미칩니다. 정기적인 파노라마 검사로 조기 발견이 가능하며, 발치와 함께 낭종 적출을 합니다.' },
  { category: '사랑니 발치', categorySlug: 'wisdom-tooth', q: '발치 후 양치질은 어떻게 해야 하나요?', a: '수술 당일은 양치질을 피하고, 다음 날부터 수술 부위를 제외한 나머지 치아는 부드럽게 양치하세요. 수술 부위는 1주일간 칫솔이 닿지 않도록 하고, 처방된 가글액(클로르헥시딘 등)으로 가볍게 헹궈주세요. 실밥 제거 후부터 정상 양치가 가능합니다.' },
  { category: '사랑니 발치', categorySlug: 'wisdom-tooth', q: '사랑니가 충치라면 때우지 않고 빼야 하나요?', a: '사랑니가 정상 맹출하여 기능하고 있고, 충치가 크지 않다면 치료(레진·크라운)로 보존할 수 있습니다. 하지만 접근이 어려운 위치의 사랑니는 치료가 힘들고 재발률이 높아 발치를 권하는 경우가 많습니다. 인접 치아에 충치를 유발하고 있다면 발치가 더 나은 선택일 수 있습니다.' },
  ...
  // 심미보철 추가 10개 (총 20개)
  { category: '심미보철', categorySlug: 'cosmetic', q: '라미네이트가 떨어질 수 있나요?', a: '매우 드물지만 강한 외력이나 접착 불량으로 탈락할 수 있습니다. 앞니로 딱딱한 음식(사과 통째로 베어 물기, 얼음 깨물기)을 피하시면 위험이 최소화됩니다. 탈락 시 라미네이트를 가지고 내원하시면 재접착 또는 재제작이 가능합니다.' },
  { category: '심미보철', categorySlug: 'cosmetic', q: '테트라사이클린 변색도 개선할 수 있나요?', a: '항생제(테트라사이클린)에 의한 변색은 일반 미백으로는 효과가 제한적입니다. 라미네이트나 올세라믹 크라운으로 확실하게 개선할 수 있습니다. 변색 정도에 따라 0.5~0.7mm 삭제 후 세라믹을 접착하여 균일하고 밝은 색상을 구현합니다.' },
  { category: '심미보철', categorySlug: 'cosmetic', q: '잇몸 성형(잇몸 라인 정리)도 가능한가요?', a: '네, 웃을 때 잇몸이 많이 보이는 거미 스마일(Gummy Smile)이나 잇몸 라인이 불균형한 경우, 잇몸 성형(치관 연장술)으로 개선할 수 있습니다. 구강외과 전문의가 잇몸과 뼈를 정밀하게 조절하여 조화로운 스마일 라인을 만듭니다. 라미네이트·크라운과 병행하면 더 완벽합니다.' },
  { category: '심미보철', categorySlug: 'cosmetic', q: '심미보철 치료 기간은 얼마나 걸리나요?', a: 'CEREC 싱글 크라운은 당일~1주 내 완료됩니다. 라미네이트는 디지털 스캔 후 기공소 제작에 7~14일, 이후 장착하면 완성입니다. 여러 개 동시 진행 시 2~3주 정도 소요됩니다. 결혼·면접 등 일정이 있으시면 미리 말씀해주시면 맞춰드립니다.' },
  { category: '심미보철', categorySlug: 'cosmetic', q: '앞니가 깨졌는데 어떤 치료가 좋은가요?', a: '깨진 범위가 작으면 레진 본딩으로 당일 수복이 가능합니다. 깨진 범위가 크거나 신경이 노출된 경우 크라운이 필요할 수 있습니다. 급한 경우 당일 응급 처치가 가능하니 빨리 내원해주세요. 깨진 치아 조각이 있다면 우유에 담가 가져오시면 도움이 됩니다.' },
  { category: '심미보철', categorySlug: 'cosmetic', q: '이갈이가 있는데 라미네이트를 할 수 있나요?', a: '이갈이(브럭시즘)가 심한 경우 라미네이트 파절 위험이 높아 일반적으로 권장하지 않습니다. 지르코니아 크라운은 강도가 높아 이갈이 환자에게 더 적합합니다. 야간 보호장치(나이트가드)를 함께 사용하시면 보철 수명을 연장할 수 있습니다.' },
  { category: '심미보철', categorySlug: 'cosmetic', q: 'PFM(도재) 크라운의 잇몸 변색이 신경 쓰여요.', a: 'PFM 크라운은 금속 하부 구조 위에 도재를 올린 형태라, 시간이 지나면 잇몸 라인에 금속이 비치거나 잇몸이 검게 변색될 수 있습니다. 올세라믹이나 지르코니아 크라운으로 교체하면 이 문제가 완전히 해결됩니다. CEREC으로 정밀하게 재제작 가능합니다.' },
  { category: '심미보철', categorySlug: 'cosmetic', q: '치아 삭제가 걱정되는데, 최소 삭제로도 가능한가요?', a: '라미네이트는 치아 앞면 0.3~0.5mm만 삭제하여 보존적이고, 레진 본딩은 삭제 없이 접착만으로 가능합니다. "노프렙(No-Prep) 라미네이트"도 일부 케이스에서 가능합니다. 치아 삭제를 최소화하면서 최상의 심미를 구현하는 방법을 안내드립니다.' },
  { category: '심미보철', categorySlug: 'cosmetic', q: '라미네이트 비용은 얼마인가요?', a: '강남치과의원 라미네이트는 1개당 60만원입니다. 앞니 4~8개를 함께 하시는 경우가 많으며, 정밀 진단 후 필요한 개수와 총 비용을 안내드립니다. CEREC 지르코니아 크라운은 50만원, 금 크라운은 100만원입니다.' },
  { category: '심미보철', categorySlug: 'cosmetic', q: '심미보철 후 관리 방법은 무엇인가요?', a: '일반 치아처럼 양치·치실·치간칫솔로 관리하세요. 앞니로 딱딱한 것 깨물기, 손톱 물어뜯기, 젓가락으로 뼈 씹기 등은 피하세요. 이갈이가 있으면 나이트가드 착용을 권합니다. 6개월마다 정기 검진으로 보철 상태를 확인하시면 오래 사용할 수 있습니다.' },
  ...
  // 충치·신경치료 추가 8개 (총 16개)
  { category: '충치·신경치료', categorySlug: 'cavity', q: '충치 치료가 아프나요?', a: '마취 후 진행하므로 치료 중 통증은 거의 없습니다. 마취 주사 자체도 가느다란 바늘과 서서히 주입하는 기법으로 통증을 최소화합니다. 치료 후 마취가 풀리면 약간의 시림이 있을 수 있으나 보통 1~2일 내 사라집니다.' },
  { category: '충치·신경치료', categorySlug: 'cavity', q: '신경치료 중인데 통증이 지속됩니다. 정상인가요?', a: '신경치료 초기(1~2회차)에는 치아 내부의 감염 조직을 제거하면서 일시적 통증이 있을 수 있습니다. 대부분 처방약으로 관리되며, 소독이 진행될수록 통증이 줄어듭니다. 하지만 극심한 통증이나 부기가 심해지면 즉시 내원하셔서 확인받으세요.' },
  { category: '충치·신경치료', categorySlug: 'cavity', q: '아이(어린이)의 유치 충치도 꼭 치료해야 하나요?', a: '네, 유치 충치를 방치하면 그 아래 자라는 영구치의 발육과 배열에 영향을 줄 수 있습니다. 유치의 조기 상실은 영구치의 공간 부족과 부정교합으로 이어질 수 있습니다. 아이의 유치 충치는 가능한 빨리 치료하고, 실란트로 예방하시는 것을 권합니다.' },
  { category: '충치·신경치료', categorySlug: 'cavity', q: '충치 치료 재료 중 어떤 것이 가장 좋은가요?', a: '치아색 레진이 현재 가장 널리 사용되며, 심미성과 접착력이 우수합니다. 넓은 충치에는 세라믹 인레이나 지르코니아 크라운이 강도와 내구성 면에서 우수합니다. 아말감(은색)은 저렴하고 내구성이 좋지만 심미성이 떨어져 최근에는 사용이 줄고 있습니다.' },
  { category: '충치·신경치료', categorySlug: 'cavity', q: '신경치료를 하면 치아가 죽는 건가요?', a: '신경(치수)을 제거하면 치아에 영양 공급이 줄어들지만, 치아 자체는 턱뼈에 뿌리를 통해 고정되어 있으므로 "죽는 것"은 아닙니다. 다만 수분이 줄어 약해지므로 크라운으로 보호하는 것이 필수이며, 잘 관리하면 10년 이상 충분히 사용 가능합니다.' },
  { category: '충치·신경치료', categorySlug: 'cavity', q: '충치 치료 비용은 얼마나 드나요?', a: '레진 충전은 8만원~17만원(크기에 따라), 글래스아이오노머/아말감은 건강보험 적용 시 1~3만원. 신경치료는 건강보험 적용(본인부담금 3~8만원), 크라운은 지르코니아 50만원, 금 100만원입니다. 정확한 비용은 진단 후 안내드립니다.' },
  { category: '충치·신경치료', categorySlug: 'cavity', q: '치아에 금이 갔는데 충치인가요?', a: '치아에 금(크랙)이 가는 것은 충치와 다릅니다. 금니크랙(Cracked Tooth)은 씹을 때 찌릿한 통증이 특징입니다. 초기 균열은 크라운으로 보호하면 보존 가능하지만, 뿌리까지 갈라진 경우 발치가 필요할 수 있습니다. 조기 발견이 중요하므로 증상 발생 시 빨리 내원하세요.' },
  { category: '충치·신경치료', categorySlug: 'cavity', q: '재신경치료(재근관치료)란 무엇인가요?', a: '이전 신경치료가 실패하여(감염 재발, 불완전한 충전 등) 다시 근관 치료를 하는 것입니다. 기존 충전물을 제거하고 근관을 재소독·재충전합니다. 재치료 성공률은 약 70~80%이며, 실패 시 치근단 절제술이나 발치를 고려합니다. 강남치과의원에서는 정밀한 재근관치료가 가능합니다.' },
  ...
  // 잇몸·스케일링 추가 8개 (총 16개)
  { category: '잇몸·스케일링', categorySlug: 'gum', q: '치주낭이란 무엇인가요?', a: '치주낭은 치아와 잇몸 사이의 틈(골)입니다. 건강한 잇몸의 치주낭 깊이는 1~3mm이며, 4mm 이상이면 치주질환이 진행 중인 것입니다. 깊은 치주낭에는 세균과 치석이 쌓이기 쉬워 잇몸뼈 흡수가 가속됩니다. 정기 검진 시 치주낭 깊이를 측정하여 잇몸 상태를 평가합니다.' },
  { category: '잇몸·스케일링', categorySlug: 'gum', q: '치근활택술(SRP)이란 무엇인가요?', a: '스케일링으로 제거하기 어려운 잇몸 아래 깊은 곳의 치석과 오염물질을 제거하고, 치아 뿌리 표면을 매끄럽게 다듬는 시술입니다. 마취 후 진행하며 보통 4회(4분면)에 나눠서 합니다. 건강보험이 적용되며, 치주염 치료의 핵심 시술입니다.' },
  { category: '잇몸·스케일링', categorySlug: 'gum', q: '잇몸이 내려앉아 치아 뿌리가 보여요. 어떻게 해야 하나요?', a: '잇몸 퇴축(치은퇴축)은 잘못된 칫솔질(과도한 힘), 치주질환, 노화 등이 원인입니다. 노출된 뿌리는 충치와 시림에 취약합니다. 경미한 경우 시린이 치약과 불소 도포로 관리하고, 심한 경우 잇몸 이식술(결합조직 이식)로 회복할 수 있습니다. 올바른 칫솔질 교육도 필수입니다.' },
  { category: '잇몸·스케일링', categorySlug: 'gum', q: '잇몸질환과 전신질환의 관계가 있나요?', a: '네, 많은 연구에서 치주질환이 심혈관 질환, 당뇨병, 조산·저체중아, 폐렴, 알츠하이머 등과 관련이 있다고 보고되었습니다. 잇몸 염증으로 인한 세균과 염증 물질이 혈관을 통해 전신에 영향을 미치기 때문입니다. 잇몸 관리는 구강뿐만 아니라 전신 건강에도 중요합니다.' },
  { category: '잇몸·스케일링', categorySlug: 'gum', q: '흡연이 잇몸에 어떤 영향을 미치나요?', a: '흡연은 잇몸 혈류를 감소시켜 잇몸질환 발생 위험을 2~6배 높입니다. 또한 출혈이 덜 나타나 질환을 알아차리기 어려워 조기 발견이 지연됩니다. 치주치료 효과도 비흡연자보다 떨어집니다. 잇몸 건강을 위해 금연을 강력히 권합니다.' },
  { category: '잇몸·스케일링', categorySlug: 'gum', q: '스케일링 후 치아 사이가 벌어진 느낌이 나요.', a: '치석이 치아 사이를 채우고 있던 것이 제거되면서 원래 공간이 보이게 된 것입니다. 이미 잇몸이 내려간 상태였으나 치석에 가려져 있었을 뿐입니다. 스케일링이 치아를 벌어지게 한 것이 아니라, 기존 상태가 드러난 것입니다. 꾸준한 관리로 더 이상 악화를 방지하세요.' },
  { category: '잇몸·스케일링', categorySlug: 'gum', q: '구취(입 냄새)가 심한데 잇몸질환 때문인가요?', a: '잇몸질환은 구취의 가장 흔한 원인 중 하나입니다. 치주낭 속 세균이 황화합물(VSC)을 생성하여 나쁜 냄새를 만듭니다. 스케일링과 치주치료로 원인을 제거하면 구취가 크게 개선됩니다. 혀 세정, 치실 사용도 구취 예방에 도움됩니다.' },
  { category: '잇몸·스케일링', categorySlug: 'gum', q: '당뇨 환자는 잇몸 관리를 어떻게 해야 하나요?', a: '당뇨와 치주질환은 서로 악화시키는 양방향 관계입니다. 당뇨 환자는 감염 저항력이 약해 치주질환이 빠르게 진행되고, 치주질환은 혈당 조절을 방해합니다. 3~4개월마다 정기 스케일링과 치주 관리를 받으시고, 혈당 관리와 구강 관리를 함께 철저히 하시는 것이 중요합니다.' },

  // ===== 미백·레진·틀니·기타 (20개) - 기존 비용·예약·기타 확장 =====
  ...
  // 비용·예약·기타 추가 10개 (총 20개)
  { category: '비용·예약·기타', categorySlug: 'general', q: '치아미백은 안전한가요?', a: '전문의가 관리하는 오피스 미백은 안전합니다. 일시적 시린감이 있을 수 있으나 1~2일 내 자연 소실됩니다. 미백 약제는 치아 구조를 손상시키지 않습니다. 임산부, 수유 중인 분, 14세 미만은 권장하지 않습니다.' },
  { category: '비용·예약·기타', categorySlug: 'general', q: '미백 효과는 얼마나 지속되나요?', a: '생활 습관에 따라 6개월~2년 유지됩니다. 커피, 차, 와인, 흡연 등 착색 요인을 줄이면 더 오래 유지됩니다. 듀얼 미백(전문가+자가)이 가장 오래 지속됩니다. 강남치과의원 전체 미백 비용은 60만원입니다.' },
  { category: '비용·예약·기타', categorySlug: 'general', q: '레진 치료는 보험 적용이 되나요?', a: '12세 이하 어린이의 영구치 레진 치료는 건강보험이 적용됩니다(제1·제2대구치 포함). 성인은 비급여이며, 강남치과의원 레진 비용은 크기에 따라 8만원~17만원입니다. 아말감, 글래스아이오노머는 성인도 보험 적용됩니다.' },
  { category: '비용·예약·기타', categorySlug: 'general', q: '틀니는 건강보험이 적용되나요?', a: '만 65세 이상이면 7년에 1회 건강보험으로 틀니를 제작할 수 있습니다. 부분틀니 본인부담금 약 30~50만원, 전체틀니 본인부담금 약 40~60만원 수준입니다. 임플란트 틀니(오버덴처)는 비급여입니다.' },
  { category: '비용·예약·기타', categorySlug: 'general', q: '치과 치료비 세금 공제(연말정산)가 되나요?', a: '네, 치과 치료비는 의료비 세액공제 대상입니다. 총 급여의 3%를 초과하는 의료비에 대해 15% 세액공제를 받을 수 있습니다. 임플란트, 교정, 미백, 크라운 등 비급여 항목도 포함됩니다. 현금영수증이나 카드 결제 내역으로 증빙하세요.' },
  { category: '비용·예약·기타', categorySlug: 'general', q: '첫 방문 시 무엇을 준비해야 하나요?', a: '신분증(건강보험증)과 이전 치과 자료(있으면)를 가져오시면 됩니다. 현재 복용 중인 약 목록, 전신 질환 이력도 알려주시면 안전한 진료에 도움됩니다. 첫 방문 시 파노라마 X-ray와 구강 검진을 진행하며, 소요 시간은 약 30~40분입니다.' },
  { category: '비용·예약·기타', categorySlug: 'general', q: '치과 공포증이 있는데 어떻게 해야 하나요?', a: '치과 공포증은 매우 흔하며, 강남치과의원은 환자분의 불안을 충분히 이해합니다. 자세한 설명으로 불안을 줄이고, 통증 최소화 마취 기법을 사용합니다. 치료 중 불편하시면 언제든 손을 들어 멈출 수 있습니다. 편안한 진료 환경에서 천천히 시작해보세요.' },
  { category: '비용·예약·기타', categorySlug: 'general', q: '턱관절이 아프면 치과에 가야 하나요?', a: '네, 턱관절 질환(TMJ)은 치과에서 진단하고 치료합니다. 입 벌릴 때 "딱딱" 소리, 턱 통증, 개구 제한 등이 있으면 내원하세요. 스플린트(교합안정장치), 약물 치료, 물리치료 등으로 개선할 수 있습니다. 강남치과의원에서 정밀 진단 후 맞춤 치료를 안내드립니다.' },
  { category: '비용·예약·기타', categorySlug: 'general', q: '치과 정기검진은 얼마나 자주 받아야 하나요?', a: '일반 성인은 6개월~1년마다 정기 검진을 권장합니다. 잇몸질환 치료 후는 3~6개월, 임플란트 보유자는 6개월, 당뇨·흡연자는 3~6개월마다 검진하세요. 정기 검진 시 파노라마 촬영, 잇몸 검사, 구강 카메라 검사를 진행하여 문제를 조기 발견합니다.' },
  { category: '비용·예약·기타', categorySlug: 'general', q: '봉화, 예천, 안동에서도 내원하시는 분이 있나요?', a: '네, 강남치과의원은 영주시뿐만 아니라 봉화군(차량 30분), 예천군(차량 35분), 안동시(차량 40분), 단양군(차량 45분) 등 인근 지역에서도 많은 환자분들이 내원하십니다. 구강외과 전문의 2인 진료, 대학병원급 장비, 전문 수술 역량 때문에 원거리에서도 찾아주시는 분이 많습니다.' },
]
...
export function faqPage(selectedCategory?: string): { html: string; title: string; description: string; schemas: object[] } {
  ...
  const description = selectedCategory
    ...
    : '강남치과의원 전체 진료에 대한 자주 묻는 질문과 상세 답변 170개. 임플란트, 디지털보철, 인비절라인, 사랑니, 잇몸치료, 미백, 비용 등 상세 FAQ.'
  ...
  <section class="relative min-h-[40vh] md:min-h-[55vh] flex items-end subpage-hero overflow-hidden">
    ...
    <div class="relative z-10 max-w-[1440px] mx-auto px-5 md:px-8 lg:px-12 pb-16 pt-28 md:pb-24 md:pt-44 w-full">
      ...
      <p class="text-gray-400 text-lg" data-speakable="true">영주 강남치과의원에 대해 궁금하신 점을 모았습니다.<br>구강외과 전문의 2인이 직접 답변합니다. <strong>총 ${allFAQs.length}개 FAQ</strong></p>
    </div>
  </section>

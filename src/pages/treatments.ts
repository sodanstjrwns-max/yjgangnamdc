...
const treatments: Treatment[] = [
  { slug:'implant', category:'전문센터', title:'임플란트', icon:'fa-tooth',
    ...
    sections:[
      ...
      { title:'강남치과의원 임플란트 장비', content:'• <strong>3D CT (CBCT)</strong>: 0.1mm 정밀도의 3D 입체 촬영으로 턱뼈를 정확하게 분석\n• <strong>PrimeScan</strong>: 초정밀 구강 스캐너로 디지털 인상 채득 (본뜨기 불필요)\n• <strong>디지털 임플란트 가이드</strong>: CT 데이터 기반 맞춤형 수술 가이드 제작\n• <strong>네오 임플란트</strong>: 국산 프리미엄 임플란트 시스템 사용\n• <strong>지르코니아·세라믹 보철</strong>: 고강도 맞춤형 크라운으로 최종 보철 완성' }
    ] },
  { slug:'digital-prosthesis', category:'전문센터', title:'디지털 보철 (CEREC)', icon:'fa-bolt',
    h1:'CEREC 디지털 보철 – 싱글 크라운 전문', description:'CEREC 디지털 보철 시스템으로 싱글 지르코니아·세라믹 크라운을 원내에서 정밀 제작합니다. 디지털 스캔으로 본뜨기 없이 편안하게.',
    heroDesc:'디지털 스캔으로 싱글 크라운을 정밀 제작합니다', worry:'"자연스러운 크라운을 원해요"', promise:'지르코니아·세라믹 크라운을 정밀하게 제작합니다',
    features:['CEREC 디지털 시스템','싱글 지르코니아 크라운','싱글 세라믹 크라운','디지털 스캔 정밀 제작','자연치아색 재현'], isTop:true,
    sections:[
      ...
      { title:'현재 CEREC으로 제작 가능한 보철', content:'현재 강남치과의원에서는 CEREC 시스템으로 <strong>싱글 지르코니아 크라운</strong>과 <strong>싱글 세라믹 크라운</strong>을 제작하고 있습니다.\n\n<strong>싱글 지르코니아 크라운</strong>\n세라믹 계열 중 가장 높은 강도를 가진 소재입니다. 어금니처럼 강한 교합력이 필요한 부위에 적합하며, 심미성도 우수합니다. 신경치료 후 치아 보호, 큰 충치 수복, 깨진 치아 복원에 사용됩니다.\n\n<strong>싱글 세라믹(올세라믹) 크라운</strong>\n빛 투과성이 자연치아와 유사하여 가장 자연스러운 결과를 만듭니다. 앞니 보철에 특히 적합하며, 자연치아와 거의 구분이 안 되는 색감을 구현합니다.' },
      { title:'CEREC 디지털 크라운의 장점', content:'• <strong>높은 정밀도</strong>: 디지털 스캔 + 컴퓨터 설계로 0.01mm 단위 정밀 제작\n• <strong>자연스러운 색감</strong>: 세라믹 블록의 그라데이션이 자연치아와 흡사\n• <strong>강도 우수</strong>: SpeedFire 소성으로 최종 강도 확보\n• <strong>생체친화성</strong>: 금속 프리(Metal-Free) 세라믹으로 알레르기 걱정 없음\n• <strong>본뜨기 불필요</strong>: 디지털 스캔으로 편안하게 제작 가능' },
  ...
  { slug:'cosmetic', category:'전문센터', title:'심미보철', icon:'fa-gem',
    h1:'심미보철 – 자연스러운 라미네이트·크라운', description:'심미보철 전문. CEREC 디지털 시스템으로 싱글 크라운을 정밀 제작하고, 라미네이트 등은 기공소와 협력하여 완성합니다.',
    heroDesc:'디지털 스캔으로 자연스러운 보철을 만듭니다', worry:'"자연스러운 이를 원해요"', promise:'디지털 기술로 맞춤 제작, 자연치아와 구분이 어렵습니다',
    features:['라미네이트·올세라믹','CEREC 싱글 크라운','자연치아색 완벽 재현','PrimeScan 디지털 스캔','정밀 맞춤 제작'], isTop:true,
    sections:[
      { title:'심미보철이란?', content:'심미보철은 치아의 기능 회복뿐만 아니라, 형태·색상·배열까지 고려하여 자연치아처럼 아름답게 만드는 보철 치료입니다.\n\n단순히 "씌운다"가 아니라, 환자의 얼굴형, 피부톤, 입술 라인, 웃을 때 보이는 치아의 양 등을 종합적으로 분석하여 가장 자연스럽고 조화로운 결과를 만들어냅니다.\n\n강남치과의원에서는 CEREC 디지털 시스템으로 싱글 지르코니아·세라믹 크라운을 정밀 제작하며, 라미네이트 등 기타 심미보철은 기공소와 협력하여 높은 품질로 완성합니다. 디지털 스캔 데이터를 기반으로 보철을 설계하므로, 좌우 대칭, 치아 간 간격, 교합 관계 등이 정밀하게 반영됩니다.' },
  ...
  { slug:'cavity', category:'일반', title:'충치치료', icon:'fa-tooth', h1:'충치치료 – 당일 발수·근충 가능', description:'충치치료. 레진, 인레이부터 신경치료·크라운까지. 디지털 정밀 진단으로 최적의 치료를 제공합니다.',
    heroDesc:'초기 충치부터 심한 충치까지, 당일 치료 가능합니다', worry:'', promise:'',
    features:['당일 발수 가능','CEREC 싱글 크라운','레진·인레이 수복','통증 최소화'], isTop:false,
    sections:[
  ...
  { slug:'crown', category:'일반', title:'크라운', icon:'fa-crown', h1:'크라운 – CEREC 디지털 정밀 제작', description:'크라운 치료. CEREC 시스템으로 싱글 올세라믹·지르코니아 크라운을 디지털 정밀 제작합니다.',
    heroDesc:'CEREC으로 싱글 크라운을 정밀하게 제작합니다', worry:'', promise:'',
    features:['CEREC 정밀 제작','올세라믹·지르코니아','자연스러운 색상','싱글 크라운 전문'], isTop:false,
    sections:[
...
export async function treatmentDetailPage(slug: string): Promise<{ html: string; title: string; description: string; schemas: object[] } | null> {
  ...
  const treatmentMeta: Record<string, {
    ...
    'implant': {
      ...
      followup: '정기 경과 관찰 (1주·1개월·3개월·6개월), 디지털 보철 장착 가능',
    ...
    'digital-prosthesis': {
      ...
      indication: '충치 후 싱글 지르코니아 크라운, 싱글 세라믹 크라운',

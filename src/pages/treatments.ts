...
export async function treatmentDetailPage(slug: string): Promise<{ html: string; title: string; description: string; schemas: object[] } | null> {
  ...
  const treatmentFAQs: Record<string, { q: string; a: string }[]> = {
    ...
    'resin': [
      { q: '레진 치료는 보험 적용이 되나요?', a: '12세 이하 어린이의 영구치 레진 치료는 건강보험이 적용됩니다(제1·제2대구치 포함). 성인은 비급여이며, 강남치과의원 레진 비용은 크기에 따라 8만원~17만원입니다. 아말감, 글래스아이오노머는 성인도 보험 적용됩니다.' },
      { q: '레진 치료는 얼마나 오래 유지되나요?', a: '일반적으로 3~7년 정도 유지되며, 관리 상태에 따라 10년 이상도 가능합니다. 착색·마모 시 부분 수리나 교체가 간편합니다. 커피, 카레, 흡연 등은 레진 변색을 촉진하니 주의하세요.' },
      ...
      { q: '레진 치료 비용은 얼마인가요?', a: '강남치과의원 레진 비용은 충치 크기에 따라 8만원~17만원입니다. 당일 치료 완료 가능하며, 자연치아색에 맞춰 충전하므로 심미성이 우수합니다.' },
      { q: '아말감과 레진 중 어떤 것이 좋은가요?', a: '아말감은 보험 적용되어 저렴하고 내구성이 좋지만 은색으로 심미성이 떨어집니다. 레진은 치아색과 동일하여 자연스럽고, 접착력이 좋아 건강한 치아를 더 많이 보존합니다. 현재는 레진이 가장 많이 사용됩니다.' },
      { q: '레진이 빠질 수 있나요?', a: '드물지만 교합력이 강한 부위나 넓은 범위의 레진은 탈락할 수 있습니다. 빠진 레진은 가져오셔도 되고, 새로 충전할 수도 있습니다. 탈락이 반복되면 인레이나 크라운으로 전환을 권합니다.' },
    ],
    'whitening': [
      { q: '치아 미백은 안전한가요?', a: '전문의가 관리하는 오피스 미백은 안전합니다. 일시적 시린감이 있을 수 있으나 1~2일 내 자연 소실됩니다. 미백 약제는 치아 구조를 손상시키지 않습니다. 임산부, 수유 중, 14세 미만은 권장하지 않습니다.' },
      ...
      { q: '미백 후 음식 제한이 있나요?', a: '미백 직후 24~48시간은 착색 음식(커피, 카레, 콜라, 와인, 간장 등)을 피하세요. 이 기간 동안 치아 표면이 착색에 취약합니다. 이후에는 정상 식사 가능하지만, 착색 음식을 줄이면 미백 효과가 더 오래 유지됩니다.' },
      { q: '보철물(크라운, 레진)도 미백이 되나요?', a: '아니요, 미백 약제는 자연치아에만 작용하며 보철물(크라운, 레진, 인레이)은 미백되지 않습니다. 미백 후 보철물과 자연치아의 색 차이가 생기면, 보철물을 미백 후 색상에 맞춰 재제작할 수 있습니다. 보철 교체 계획이 있다면 미백을 먼저 하시는 것이 좋습니다.' },
      { q: '미백 중 시린 증상이 심하면 어떻게 하나요?', a: '미백 중 일시적 시림은 흔한 반응입니다. 시림이 심하면 미백 빈도를 줄이거나 (2일에 1회), 시린이 전용 치약을 사용하세요. 증상이 심하면 잠시 미백을 중단하고 2~3일 후 재개합니다. 대부분 미백 종료 후 자연 소실됩니다.' },
      { q: '자가 미백 트레이는 어떻게 관리하나요?', a: '사용 후 미지근한 물로 세척하고 건조시켜 보관하세요. 뜨거운 물은 트레이 변형의 원인이 됩니다. 전용 케이스에 보관하시고, 미백 완료 후에도 터치업(유지 미백)용으로 보관하시면 좋습니다.' },
    ],
    'bone-graft': [
      ...
      { q: '뼈이식재는 어떤 종류가 있나요?', a: '자가골(본인 뼈, 생착률 최고), 동종골(인체 뼈 가공), 이종골(소뼈 가공, 가장 널리 사용), 합성골(인공 제조)이 있습니다. 각각 장단점이 있으며, 뼈 부족 정도와 부위에 따라 최적의 이식재를 선택합니다.' },
      { q: '뼈이식과 임플란트를 동시에 할 수 있나요?', a: '뼈 부족이 경미~중등도인 경우 임플란트 식립과 동시에 뼈이식을 시행할 수 있습니다. 이 경우 내원 횟수와 전체 치료 기간을 크게 단축할 수 있습니다. 뼈가 심하게 부족한 경우에는 뼈이식 먼저 하고 4~6개월 뒤 임플란트를 식립합니다.' },
      { q: '뼈이식 후 주의사항은 무엇인가요?', a: '수술 부위를 혀나 손으로 만지지 마세요. 2주간 뜨거운 음식, 음주, 격렬한 운동을 피하세요. 처방약을 정해진 대로 복용하고, 부기 관리를 위해 아이스팩을 사용하세요. 수술 부위 칫솔질은 1주 후부터 부드럽게 시작하세요.' },
      { q: '다른 치과에서 뼈 부족으로 거절당했는데 가능한가요?', a: '네, 구강외과 전문의의 전문 영역입니다. 뼈이식은 고난이도 수술로, 전문의의 경험과 기술에 따라 결과가 크게 달라집니다. 강남치과의원은 구강외과 전문의 2인이 다양한 뼈이식 수술을 시행하고 있으며, 타 병원 거절 케이스도 많이 대응합니다.' },
    ],
    'sinus-lift': [
      ...
      { q: '치조정접근법과 측방접근법의 차이는 무엇인가요?', a: '치조정접근법은 임플란트 구멍을 통해 상악동 점막을 올리는 방법(잔존 뼈 5mm 이상)으로 절개가 작고 회복이 빠릅니다. 측방접근법은 잇몸과 뼈를 옆에서 열어 접근(잔존 뼈 5mm 미만)하며 더 많은 뼈이식이 가능합니다. CT 분석 후 최적 방법을 결정합니다.' },
      { q: '상악동 거상술과 임플란트를 동시에 할 수 있나요?', a: '잔존 뼈 높이가 4~5mm 이상이면 치조정접근법으로 상악동 거상술과 임플란트 식립을 동시에 시행할 수 있습니다. 잔존 뼈가 매우 부족하면 측방접근법으로 뼈이식 먼저 하고 4~6개월 후 임플란트를 식립합니다.' },
      { q: '비염이나 축농증이 있어도 상악동 거상술이 가능한가요?', a: '만성 비염은 대부분 수술에 큰 문제가 없으나, 활동성 축농증(급성 상악동염)이 있으면 이비인후과 치료 후 수술을 권합니다. 3D CT에서 상악동 내 점막 비후나 병변을 확인하여 수술 적합성을 판단합니다.' },
      { q: '상악동 거상술 후 코피가 나면 정상인가요?', a: '수술 후 1~2일간 코에서 약간의 혈성 분비물이 나올 수 있으며 이는 정상입니다. 코를 세게 풀지 말고 부드럽게 닦아주세요. 다량의 코피가 지속되면 즉시 치과에 연락하세요.' },
    ],

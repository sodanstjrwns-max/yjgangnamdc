...
const areaData: Record<string, AreaInfo> = {
  ...
  '영주역': {
    ...
    localKeywords: ['영주역 치과', '영주역 근처 치과', '영주 KTX 치과', '영주역 임플란트', '영주역 앞 치과'],
  ...
  '풍기': {
    ...
    localKeywords: ['풍기 치과', '풍기 임플란트', '풍기읍 치과', '풍기 치과 추천', '풍기 사랑니', '풍기 인비절라인', '소백산 근처 치과', '풍기 임플란트 가격', '풍기에서 영주 치과'],
  ...
  '예천': {
    ...
    localKeywords: ['예천 치과', '예천 임플란트', '예천군 치과 추천', '예천 사랑니', '예천 임플란트 잘하는곳', '예천에서 영주 치과', '예천 구강외과', '예천 인비절라인', '예천 임플란트 가격'],
  ...
  '단양': {
    ...
    localKeywords: ['단양 치과', '단양 임플란트', '단양군 치과 추천', '단양 치과 전문의', '단양 사랑니', '단양에서 가까운 치과', '단양 임플란트 가격', '단양에서 영주 치과'],
  ...
  '영덕': {
    ...
    localKeywords: ['영덕 치과', '영덕 임플란트', '영덕군 치과 추천', '영덕 사랑니', '영덕 임플란트 잘하는곳', '영덕에서 영주 치과'],
  ...
  '울진': {
    ...
    localKeywords: ['울진 치과', '울진 임플란트', '울진군 치과 추천', '울진 사랑니', '울진 임플란트 잘하는곳', '울진에서 영주 치과'],
  ...
  '영주혁신도시': {
    ...
    localKeywords: ['영주혁신도시 치과', '혁신도시 치과', '영주혁신도시 임플란트', '영주혁신도시 치과 추천', '혁신도시 인비절라인', '영주 혁신도시 사랑니'],
  ...
  '상주': {
    name: '상주', slug: 'sangju', driveTime: '약 50분', driveKm: '약 60km',
    description: '상주시에서 자동차로 약 50분 거리입니다. 중앙고속도로를 이용하면 빠르게 접근 가능합니다.',
    longDescription: '상주시는 인구 약 9.5만 명의 경북 서북부 도시로, 경천대, 상주 자전거박물관, 낙동강 자전거길 등으로 유명합니다. 상주시에도 치과가 여러 곳 있지만, 구강악안면외과 전문의가 2인 상주하면서 뼈이식·상악동 거상술 등 고난이도 수술까지 원스톱으로 가능한 곳은 영주 강남치과의원이 가장 가깝습니다. 중앙고속도로(점촌함창IC → 영주IC)를 이용하면 약 50분이면 도착하며, 대구(약 1시간 30분)보다 가까운 거리에서 대학병원급 전문 진료를 받으실 수 있습니다.',
    priority: 3,
    subAreas: ['상주시내', '함창읍', '화북면', '화서면', '은척면', '공성면', '낙동면', '모동면', '화남면'],
    landmarks: ['경천대', '상주시청', '상주 자전거박물관', '낙동강 자전거길', '점촌역'],
    population: '약 9.5만 명',
    routeDesc: '상주시(점촌)에서 중앙고속도로 점촌함창IC → 영주IC 약 40분, 이후 시내까지 10분. 함창에서 출발 시 약 45분 소요.',
    routeHighway: '중앙고속도로 점촌함창IC → 영주IC (약 40분)',
    whyChoose: '상주시에서 구강외과 전문의 2인이 상주하는 가장 가까운 치과입니다. 뼈이식 동반 임플란트, 상악동 거상술, 복잡 사랑니 발치 등 고난이도 수술이 필요하신 상주시민은 50분 투자 가치가 있습니다.',
    nearbyCompetitors: '상주시 내 치과에서 일반 치료와 기본 임플란트는 가능하지만, 구강악안면외과 전문의의 고난이도 수술(뼈이식, 상악동 거상술, 매복 사랑니)은 대구(1시간 30분) 또는 영주(50분)로 가셔야 합니다.',
    localKeywords: ['상주 치과', '상주 임플란트', '상주시 치과 추천', '상주 임플란트 잘하는곳', '상주 사랑니', '상주 구강외과', '상주에서 영주 치과', '점촌 치과'],
    lat: 36.4108, lng: 128.1590
  },
  '문경': {
    name: '문경', slug: 'mungyeong', driveTime: '약 50분', driveKm: '약 55km',
    description: '문경시에서 자동차로 약 50분 거리입니다. 중앙고속도로를 이용하여 접근 가능합니다.',
    longDescription: '문경시는 인구 약 6.8만 명의 경북 북서부 도시로, 문경새재, 가은 오픈세트장, 문경세계도자기축제 등으로 유명합니다. 문경시에서 구강외과 전문의의 고난이도 임플란트·뼈이식·상악동 거상술을 받으려면 대구(약 2시간)까지 가셔야 했습니다. 영주 강남치과의원은 중앙고속도로를 이용하면 약 50분 거리에서 대학병원급 구강외과 전문 진료를 제공합니다. CEREC 디지털 보철로 내원 횟수를 최소화하여 원거리 환자분의 부담을 줄입니다.',
    priority: 3,
    subAreas: ['문경시내', '점촌동', '가은읍', '영순면', '산양면', '호계면', '산북면', '농암면', '마성면'],
    landmarks: ['문경새재', '문경시청', '문경레일바이크', '가은 오픈세트장', '문경세계도자기축제장'],
    population: '약 6.8만 명',
    routeDesc: '문경시내에서 3번 국도 → 점촌 → 중앙고속도로 점촌함창IC → 영주IC 약 50분(55km). 가은읍에서는 약 1시간 소요.',
    routeHighway: '3번 국도 → 중앙고속도로 점촌함창IC → 영주IC',
    whyChoose: '문경시에서 구강외과 전문의 2인의 전문 진료를 가장 가까이 받을 수 있습니다. 대구(약 2시간)까지 안 가셔도 됩니다.',
    nearbyCompetitors: '문경시 내 치과에서 기본 진료와 간단한 임플란트는 가능하지만, 구강악안면외과 전문의의 고난이도 수술(뼈이식·상악동 거상술·복잡 매복 사랑니)은 대구(2시간) 또는 영주(50분)로 가셔야 합니다.',
    localKeywords: ['문경 치과', '문경 임플란트', '문경시 치과 추천', '문경 임플란트 잘하는곳', '문경 사랑니', '문경 구강외과', '문경에서 영주 치과', '문경새재 근처 치과'],
    lat: 36.5865, lng: 128.1868
  }
}
